...
<div class="jumbotron container">
	...
	<div class="container text-center">
		<span class="h2">Add-Edit Related Diagnostic</span>
		<p>Add-Remove-Edit Related Diagnostic Questions here.</p>
	</div>
	<div class="jumbotron">
		...
		<div class="row">
			...
			<span class="h2">Related Question Title Here</span>
		</div>
		<div class="container-fluid text-left desc-body">
			<input type="text" id="relatedDiagnosticTitle" name="relatedDiagnosticTitle" class="form-control" placeholder="Enter Related Diagnostic question title Here." value="${relatedDiagnostic.relatedDiagnosticTitle}"/>
		</div>
	</div>
	<div class="jumbotron">
		<div class="container-fluid text-left">
